...
% ====================== CODE ======================
% Instructions: We should complete the code by working through the
%               following parts.
%
% Part 1: Feedforward the neural network and return the cost in the
%         variable J. After implementing Part 1, we can verify that our
%         cost function computation is correct by verifying the cost
%         computed in neuralNetwork.m
%
...
%         that our implementation is correct by running checkNNGradients
%
...
% Part 1: Feedforward Propagation & Cost Function
%--------------------------------------------------------------
X = [ones(m,1) X];
a1 = X;
z2 = a1 * Theta1';
...
delta3_X_Theta2 = delta3 * Theta2;
delta2 = delta3_X_Theta2(:,2:end) .* sigmoidGradient(z2);

% Accumulated Gradient for Theta1
Delta1 = delta2' * a1;

% Accumulated Gradient for Theta2
Delta2 = delta3' * a2;
